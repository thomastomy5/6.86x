...
def tabular_q_learning(q_func, current_state_1, current_state_2, action_index,
    ...
    TODO Your code here
    if not terminal:
    q_func[next_state_1, next_state_2, action_index,
           object_index] = (1-ALPHA)+q_func[next_state_1, next_state_2, action_index,
           object_index]+ALPHA(reward)+GAMMA*np.max(q_func())
